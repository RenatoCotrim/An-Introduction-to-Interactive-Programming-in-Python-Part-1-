# URL = http://www.codeskulptor.org/#user45_r5xL1Jndue_3.py
...
first_side_lenght=((x0-x1)**2+(y0-y1)**2)**0.5
second_side_lenght=((x1-x2)**2+(y1-y2)**2)**0.5
third_side_lenght=((x2-x0)**2+(y2-y0)**2)**0.5
semi_perimeter=0.5*(first_side_lenght+second_side_lenght+third_side_lenght)
area=(semi_perimeter*(semi_perimeter-first_side_lenght)*(semi_perimeter-second_side_lenght)*(semi_perimeter-third_side_lenght))**0.5
